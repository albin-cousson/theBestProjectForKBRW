...
var Link = createReactClass({
  ...
  }, _defineProperty(_statics, "GoTo", function GoTo(route, params, query) {
    var qs = Qs.stringify(query);
    var url = routes[route].path(params) + (qs == '' ? '' : '?' + qs);
    history.pushState({}, "", url);
    onPathChange();
  }), _defineProperty(_statics, "onPathChange", function onPathChange() {
  ...
  }), _defineProperty(_statics, "LinkTo", function LinkTo(route, params, query) {
    var qs = Qs.stringify(query);
...
//# sourceMappingURL=client.575985529a75b7654b37.js.map