...
var Orders = createReactClass({
  ...
  render: function render() {
    ...
    if (_typeof(this.props.orders.value) == this.props.orders.value) {
      return /*#__PURE__*/React.createElement(React.Fragment, null, this.props.orders.value);
    }

    if (this.props.orders.value[1] != undefined && this.props.orders.value != this.props.orders.value) {
      for (var i = 2; i > 0; i--) {
...
//# sourceMappingURL=client.db981677e33f21d12783.js.map