...
var Order = createReactClass({
  ...
  render: function render() {
    console.log(this.props.order.value.custom.items.length); // count = this.props.order.value.custom.items.length
...
//# sourceMappingURL=client.09e85b6ae680232501bb.js.map