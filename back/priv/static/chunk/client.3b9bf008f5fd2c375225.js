  ...
  viewModal: function viewModal(id) {
    ...
    this.props.modal({
      ...
      callback: function callback(value) {
        _this5.props.loader(HTTP.delete("/api/order/" + _this5.props.id).then(function () {
          location.reload();
        }));
      }
    });
    ...
    if (this.props.orders.value[1] != undefined && typeof this.props.orders.value != 'string') {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          onClick: function onClick() {
            _this6.viewModal.callback(order.id);
          }
        }, "\uF793"))));
      }))), /*#__PURE__*/React.createElement("div", {
...
//# sourceMappingURL=client.3b9bf008f5fd2c375225.js.map