...
var Orders = createReactClass({
  ...
  handleSubmit: function handleSubmit(e) {
    e.preventDefault();
    console.log(document.querySelector(".w-input").value);
  ...
  render: function render() {
    ...
    if (this.props.orders.value[this.props.orders.value.length - 1] != undifined) {
      for (var i = 2; i > 0; i--) {
    ...
    if (this.props.orders.value.pop() != undefined) {
      return /*#__PURE__*/React.createElement("div", {
        className: "orders"
      }, /*#__PURE__*/React.createElement("div", {
...
//# sourceMappingURL=client.b4bfaeb6efb9d9d568bd.js.map