...
var Orders = createReactClass({
  ...
  render: function render() {
    ...
    if (this.props.orders.value[0] == "Commande en cours de traitement") {
      console.log("ok bro");
    } else if (this.props.orders.value[1] != undefined) {
      for (var i = 2; i > 0; i--) {
...
//# sourceMappingURL=client.425ad187d5d7a2be709d.js.map