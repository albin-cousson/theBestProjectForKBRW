...
var Orders = createReactClass({
  ...
  render: function render() {
    ...
    if (this.props.orders.value[1] == "Commande en cours de traitement") {
      return /*#__PURE__*/React.createElement(React.Fragment, null, this.props.orders.value);
    }

    if (this.props.orders.value[1] != undefined && this.props.orders.value[1] != "Commande en cours de traitement") {
      for (var i = 2; i > 0; i--) {
...
//# sourceMappingURL=client.48ad65ae89342fce04a0.js.map