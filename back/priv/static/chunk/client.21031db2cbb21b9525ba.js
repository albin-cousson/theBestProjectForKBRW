...
var Orders = createReactClass({
  ...
  handleSubmit: function handleSubmit(e) {
    ...
    Link.GoTo("orders", "", _defineProperty({}, document.querySelector(".w-input").value.split(":")[0], document.querySelector(".w-input").value.split(":")[0]));
  },
  statics: {
...
//# sourceMappingURL=client.21031db2cbb21b9525ba.js.map