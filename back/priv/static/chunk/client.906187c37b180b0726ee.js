...
__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './webflow/page.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); // import bibliotèque cookies et chaine 
...
var Orders = createReactClass({
  ...
  handleSubmit: function handleSubmit(e) {
    ...
    console.log(key);
    GoTo("orders", "", _defineProperty({}, key, value));
  },
  statics: {
...
function onPathChange() {
  ...
  ReactDOM.render( /*#__PURE__*/React.createElement("p", null, "Chargement..."), document.getElementById('root'));
  addRemoteProps(browserState).then(function (props) {
    browserState = props; // Log our new browserState

    console.log(browserState); // Render our components using our remote data
...
//# sourceMappingURL=client.906187c37b180b0726ee.js.map