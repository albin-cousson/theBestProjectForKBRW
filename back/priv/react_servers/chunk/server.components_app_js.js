...
var XMLHttpRequest = __webpack_require__(/*! xhr2 */ "./node_modules/xhr2/lib/xhr2.js"); // External XmlHTTPReq on browser, xhr2 on server
...
var DeleteModal = createReactClass({
  ...
  render: function render() {
    ...
    }, /*#__PURE__*/React.createElement("h1", null, "Heading"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", {
      className: "button-2 w-button",
      onClick: function onClick() {
        _this2.props.callback(null);
      }
    }, "Annuler"), /*#__PURE__*/React.createElement("button", {
      className: "button w-button",
      onClick: function onClick() {
        _this2.props.callback(_this2.props.id);
      }
    }, "Confirmer"))));
  }
});
...
var Orders = createReactClass({
  ...
  handleSubmit: function handleSubmit(e) {
    e.preventDefault();
    Link.GoTo("orders", "", _defineProperty({}, document.querySelector(".w-input").value.split(":")[0], document.querySelector(".w-input").value.split(":")[1]));
  },
  statics: {
  ...
  render: function render() {
    ...
    if (typeof this.props.orders.value === 'string') {
      return /*#__PURE__*/React.createElement(React.Fragment, null, this.props.orders.value);
    }
    ...
    if (this.props.orders.value[1] != undefined && typeof this.props.orders.value != 'string') {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        }, order.custom.order_number))), /*#__PURE__*/React.createElement("div", {
          className: "divtable"
        }, /*#__PURE__*/React.createElement("div", {
        ...
        }, order.custom.billing_address.street + " " + order.custom.billing_address.postcode + " " + order.custom.billing_address.city))), /*#__PURE__*/React.createElement("div", {
          className: "divtable"
        }, /*#__PURE__*/React.createElement("div", {
          className: "div-block-9"
        }, /*#__PURE__*/React.createElement("div", {
          className: "textcustomtable texttable4"
        }, order.custom.items.length))), /*#__PURE__*/React.createElement("div", {
          className: "divtable"
        }, /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "textcustomtable texttable3"
      }, this.props.orders.value.custom.billing_address.street + " " + this.props.orders.value.custom.billing_address.postcode + " " + this.props.orders.value.custom.billing_address.city))), /*#__PURE__*/React.createElement("div", {
        className: "divtable"
      }, /*#__PURE__*/React.createElement("div", {
        className: "div-block-9"
      }, /*#__PURE__*/React.createElement("div", {
        ...
        className: "textcustomtable icontable texttable5",
        onClick: function onClick() {
          Link.GoTo('order', _this6.props.orders.value.id);
        }
      }, "\uF061"))), /*#__PURE__*/React.createElement("div", {
        className: "div-block-2"
      }, /*#__PURE__*/React.createElement("div", {
        ...
        className: "textcustomtable textpaytable texttable6"
      }, "Satus: ", this.props.orders.value.status.state, /*#__PURE__*/React.createElement("br", null), "Payment method: ", this.props.orders.value.custom.magento.payment.method, /*#__PURE__*/React.createElement("br", null), "Delivry: ", this.props.orders.value.custom.delivry_date))), /*#__PURE__*/React.createElement("div", {
        className: "divtable"
      }, /*#__PURE__*/React.createElement("div", {
        className: "div-block-4"
      }, /*#__PURE__*/React.createElement("div", {
        className: "textcustomtable texttable7 icontable",
        onClick: function onClick() {
          _this6.viewModal(_this6.props.orders.value.id);
        }
      }, "\uF793")))))), /*#__PURE__*/React.createElement("div", {
        className: "blockpagination wf-section"
      }, /*#__PURE__*/React.createElement("button", {
...
var Order = createReactClass({
  ...
  render: function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      }, _this7.props.order.value.custom.items.length), /*#__PURE__*/React.createElement("div", {
